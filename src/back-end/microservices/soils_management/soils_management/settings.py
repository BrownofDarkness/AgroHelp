"""
Django settings for soils_management project.
...
SECRET_KEY = 'django-insecure-w(2)!l^r*bt1=38x1o2!6)jnj1jk_9p(hwr27&$81w2vj!rig+'
...
ROOT_URLCONF = 'soils_management.urls'
...
WSGI_APPLICATION = 'soils_management.wsgi.application'
